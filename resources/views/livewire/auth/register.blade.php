      ...
      <form wire:submit.prevent="register" action="#" method="POST">
        ...
        <div class="rounded-md shadow-sm -space-y-px">
            <div class="mb-4">
                ...
                <input wire:model="username" id="username" name="username" type="text" autocomplete="username" required class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="User name">
            </div>
            @error('username')
